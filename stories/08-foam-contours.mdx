...
2. **Overlapping** - Two circles that merge where they touch
3. **Wave Line** - Horizontal line simulating breaking wave foam
...
2. **Scattered** - Multiple separate foam patches
3. **Edge Foam** - Foam touching grid boundaries
...
2. **Full** - All cells above threshold (no contour lines visible)
