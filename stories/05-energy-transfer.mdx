...
<ProgressionStrip snapshots={ENERGY_TRANSFER_STRIP_BREAKING.snapshots} testId={ENERGY_TRANSFER_STRIP_BREAKING.testId} />
...
<ProgressionStrip snapshots={ENERGY_TRANSFER_STRIP_SPREAD.snapshots} testId={ENERGY_TRANSFER_STRIP_SPREAD.testId} />
...
2. Foam grid reads from transfer and accumulates
3. Transfer grid is cleared after foam deposit
4. Foam grid persists and decays over time
