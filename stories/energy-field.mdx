...
<ProgressionPlayer snapshots={PROGRESSION_WITH_DAMPING.snapshots} />

<ProgressionStrip snapshots={PROGRESSION_WITH_DAMPING.snapshots} testId="strip-with-damping" />
