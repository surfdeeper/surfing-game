...
<ProgressionStrip snapshots={FOAM_GRID_STRIP_ACCUMULATION.snapshots} testId={FOAM_GRID_STRIP_ACCUMULATION.testId} />
...
<ProgressionStrip snapshots={FOAM_GRID_STRIP_ADVECTION.snapshots} testId={FOAM_GRID_STRIP_ADVECTION.testId} />
...
<ProgressionStrip snapshots={FOAM_GRID_STRIP_COMBINED.snapshots} testId={FOAM_GRID_STRIP_COMBINED.testId} />
...
2. **Contoured** via marching squares for outline rendering
