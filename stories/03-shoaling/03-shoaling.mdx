...
} from '../../src/render/shoalingProgressions';
...
<ProgressionStrip snapshots={SHOALING_STRIP_HEIGHT.snapshots} testId={SHOALING_STRIP_HEIGHT.testId} />
...
<ProgressionStrip snapshots={SHOALING_STRIP_COMPRESSION.snapshots} testId={SHOALING_STRIP_COMPRESSION.testId} />
...
<ProgressionStrip snapshots={SHOALING_STRIP_STATIC.snapshots} testId={SHOALING_STRIP_STATIC.testId} />
...
<ProgressionStrip snapshots={SHOALING_STRIP_COMBINED.snapshots} testId={SHOALING_STRIP_COMBINED.testId} />
