...
import { getWaveProgress, WAVE_TYPE, WAVE_X_SAMPLES } from '@surf/core/src/state/waveModel.js';
import { getHeightAt } from '@surf/core/src/state/energyFieldModel.js';
import { progressToScreenY } from '@surf/core';
